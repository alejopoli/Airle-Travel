...
public class Aviones extends JPanel implements ActionListener, MouseListener, KeyListener {
    ...
    private Object[] Columnas_Usuario = {"Codigo", "Capacidad", "Estado"};//Los nombres de las filas
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == jbtnBuscar) {
            ...
            if (Codigo.trim().length() != 0) {
                ...
                if (avionE != null) {
                    ...
                    jlbValidar.setText("El avion no se ha encontrado");
                }
            } else {
                Toolkit.getDefaultToolkit().beep();
                jpError.setBackground(new Color(237, 28, 36));
                jlbValidar.setText("Ingrese el Codigo");
        ...
        if (ae.getSource() == jbtnActualizar) {
            ...
            int option = JOptionPane.showConfirmDialog(this, "¿Está seguro de que desea actualizar el avion?", "Airline Travel", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (option == JOptionPane.YES_OPTION) {
                ...
                if (respuestau) {
                    LimpiarCampos();
                    jpError.setBackground(new Color(0, 123, 183));
                    jlbValidar.setText("Se ha actualizado el avion");
                }
            }
        }
